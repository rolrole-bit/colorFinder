  ...
  container.innerHTML = `
    <div class="split-screen-result" id="score-panel">
      ...
      <div style="position: fixed; bottom: 2rem; left: 0; right: 0; margin: 0 auto; width: calc(100% - 4rem); max-width: 800px; z-index: 3000; text-align: center; display: flex; gap: 1rem;">
        <button class="magazine-start-btn" id="retry-btn" style="flex: 1; display:flex; align-items:center; justify-content:center; mix-blend-mode: difference; filter: contrast(200%) brightness(120%); border-color: rgba(255,255,255,0.5);">
        ...
        <button class="magazine-start-btn" id="share-btn" style="flex: 1; display:flex; align-items:center; justify-content:center; mix-blend-mode: difference; filter: contrast(200%) brightness(120%); border-color: rgba(255,255,255,0.5);">
          <span style="display:flex; align-items:center; gap:0.5rem; color: #ffffff;">
